                                ...
                                <div class="col-md-6">
                                    <div class="form-group has-feedback">
                                        ...
                                        <input type="text" class="form-control required" tabindex="1" data-parsley-trigger="change" data-parsley-minlength="2" data-parsley-maxlength="15"
                                               data-parsley-pattern="^[a-zA-Z\  \/]+$" required="" value="{{ $driver->NID_no }}" name="NID_no" placeholder="Driver NID">
                                        <span class="glyphicon  form-control-feedback"></span>
                                    </div>
                                    <div class="form-group has-feedback">
                                        <label for="exampleInputEmail1">Driver Name</label>
                                        <input type="text" class="form-control required" tabindex="1" data-parsley-trigger="change" data-parsley-minlength="2" data-parsley-maxlength="15"
                                               data-parsley-pattern="^[a-zA-Z\  \/]+$" required="" name="name" value="{{ $driver->name }}" placeholder="Driver NID">
                                        <span class="glyphicon  form-control-feedback"></span>
                                    </div>
                                    ...
                                    <div class="form-group has-feedback">
                                        ...
                                        <input tabindex="5" type="text" class="form-control required" name="contact_no" data-parsley-trigger="change" data-parsley-minlength="2"
                                               data-parsley-maxlength="15" data-parsley-pattern="^[a-zA-Z0-9\  \/]+$" required="" value="{{ $driver->contact_no }}" placeholder="Mobile no...">
                                        <span class="glyphicon  form-control-feedback"></span>
                                    </div>
                                    <div class="form-group has-feedback">
                                        <label for="exampleInputEmail1">Driver photo</label>
                                        <input tabindex="4" type="file" class="form-control required" name="driver_image" value="" data-parsley-trigger="change" required="" <span class="glyphicon  form-control-feedback">
                      </span>
                                        <div class="col-md-9">
                                            <span><img src="{{ url('uploads/driver/'.$driver->driver_image)}}" style="height: 150px; width: 200px;"></span>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group has-feedback">
                                        ...
                                        <input tabindex="2" type="text" class="form-control required" name="vehicle_reg_no" data-parsley-trigger="change" data-parsley-minlength="2"
                                          value="{{ $driver->vehicle_reg_no }}"     data-parsley-maxlength="15" required="" placeholder="Bus RegiNumber">
                                        <span class="glyphicon  form-control-feedback"></span>
                                    </div>
                                    <div class="form-group has-feedback">
                                        <label for="exampleInputEmail1">Address</label>
                                        <input tabindex="4" type="text" class="form-control required" name="address" data-parsley-trigger="change" required=""
                                           value="{{ $driver->address }}"    placeholder="Address">
                                        <span class="glyphicon  form-control-feedback"></span>
                                    </div>
                                    <div class="form-group has-feedback">
                                        ...
                                        <input tabindex="4" type="text" class="form-control required" name="license_no" data-parsley-trigger="change" required=""
                                          value="{{ $driver->license_no }}"     placeholder="License No..">
                                        <span class="glyphicon  form-control-feedback"></span>
                                    </div>
                                    ...
                                    <div class="form-group has-feedback">
                                        ...
                                        <input tabindex="4" type="file" name="vehicle_image" class="form-control required" data-parsley-trigger="change" required="" <span class="glyphicon  form-control-feedback">
                                            ...
                                            <span><img src="{{ url('uploads/vehicle/'.$driver->vehicle_image)}}" style="height: 150px; width: 200px;"></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
